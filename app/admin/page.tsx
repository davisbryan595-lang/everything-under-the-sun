          ...
          <div className="bg-white border-2 border-gold p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-gold text-black px-4 py-2 font-semibold hover:text-black transition-colors btn-lift"
              >
            ...
            {showProductForm && (
              <form onSubmit={handleAddProduct} className="mb-6 p-4 bg-light-yellow border-2 border-gold">
                ...
                <div className="flex gap-2">
                  <button
                    type="submit"
                    className="bg-gold text-black px-6 py-2 font-semibold hover:text-black transition-colors btn-lift"
                  >
                    Add Product
                  </button>
                  <button
