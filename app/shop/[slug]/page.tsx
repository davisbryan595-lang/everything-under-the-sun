...
const productDetails: Record<string, any> = {
  "black-casual-dress": {
    ...
    description:
      "A comfortable and versatile black casual dress perfect for everyday wear. Great for work, casual outings, or relaxing at home.",
  ...
  "white-cotton-dress": {
    ...
    description: "A fresh and practical white cotton dress perfect for any season and any occasion.",
  ...
  "printed-summer-dress": {
    ...
    description: "A cheerful printed dress perfect for warm weather and casual summer days out.",
  ...
  "denim-shift-dress": {
    ...
    description: "A durable denim shift dress that's perfect for casual days and easy to style.",
  ...
  "coffee-tumbler": {
    ...
    description: "A stylish white coffee tumbler perfect for your daily beverage. Keep your drinks at the perfect temperature.",
    details: ["Durable ceramic", "Keeps drinks hot or cold", "Easy to clean", "Perfect for everyday use"],
    sizes: ["M"],
    colors: [{ name: "White", hex: "#FFFFFF" }],
    related: ["1", "2", "3"],
  },
  "white-sneakers": {
    ...
    description: "Classic white sneakers that go with everything. Comfortable and versatile for any casual outfit.",
  ...
  "black-leather-handbag": {
    ...
    description: "A classic black leather handbag that's both stylish and functional for everyday use.",
